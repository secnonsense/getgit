...
def construct_url(query='blah',lang='blah',stars='blah',username='blah',pushed='blah'):
    plus=0
    ...
    if (not (args.query or args.language or args.stars or args.user)) and (query=='blah' and lang=='blah' and stars=='blah' and username=='blah' and pushed=='blah'):
